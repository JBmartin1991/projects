...
namespace ProjectOrganizer
{
    public class ProjectCLI
    {
        ...
        private void CreateProject()
        {
            ...
            Project newProj = new Project(projectName, startDate, endDate)
            {
                Name = projectName,
                StartDate = startDate,
                EndDate = endDate
        ...
        private void UpdateDepartment()
        {
            ...
            Department updatedDepartment = new Department(updatedName)
            {
                Id = departmentId,
                Name = updatedName
            };
        ...
        private void GetAllEmployees()
        {
            ...
            if (employees.Count > 0)
            {
                ...
                {
                    Console.WriteLine(emp.EmployeeId.ToString().PadRight(5) + (emp.LastName + ", " + emp.FirstName).PadRight(30) + emp.JobTitle.PadRight(30) + emp.Gender.PadRight(3) + emp.BirthDate.PadRight(10));
                }                
            }
            else
            {
        ...
        private void GetAllProjects()
        {
            ...
            if (projects.Count > 0)
            {
                ...
                {
                    Console.WriteLine(proj.ProjectId.ToString().PadRight(5) + proj.Name.PadRight(20) + proj.StartDate.ToString().PadRight(10) + proj.EndDate.ToString().PadRight(10));
                }
